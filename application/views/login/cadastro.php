...
.form-signin input[type="password"] {
  ...
  <body class="text-center">
    <form class="form-signin" action="usuarios/novo" method="post">
      <img class="mb-4" src="dist/img/logo.png" alt="" width="72" height="72">
      <h1 class="h3 mb-3 font-weight-normal">Cadastre-se</h1>
      <label for="inputEmail" class="sr-only" name="nome">nome</label>
      ...
      <label for="inputPassword" class="sr-only" name="senha">Senha</label>
